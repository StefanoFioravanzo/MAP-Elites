...
class C01(ConstrainedFunction):
    ...
    def __init__(self, dimensions):
        self.o = np.array([0.030858718087483, -0.078632292353156, 0.048651146638038, -0.069089831066354, -0.087918542941928,
...
class C02(ConstrainedFunction):
    ...
    def __init__(self, dimensions):
        self.o = np.array([-0.066939099286697, 0.470966419894494, -0.490528349401176, -0.312203454689423, -0.124759576300523,
...
class C03(ConstrainedFunction):
    ...
    def __init__(self, dimensions):
        self.o = np.array([111.17633500088529, 92.07880492633424, 417.9818592609036, 253.16188128024302, 363.5279986597767,
...
class C04(ConstrainedFunction):
    ...
    def __init__(self, dimensions):
        self.o = np.array([0.820202353727904, 5.260154140335203, -1.694610371739177, -5.589298730330406, -0.141736605495543,
...
class C06(ConstrainedFunction):
    ...
    def constraints(self):
        def h1(X):
            x = np.array(X)
            z = x - self.o[:self.D]
            y = M.dot((x + 483.6106156535 - self.o[:self.D])) - 483.6106156535
...
class C07(ConstrainedFunction):
    ...
    def __init__(self, dimensions):
        self.o = np.array([-1.46823271282738, 47.51401860909492, -30.421056514069576, -7.707941671844303, -21.74698421666629,
...
class C09(ConstrainedFunction):
    ...
    def __init__(self, dimensions):
        self.o = np.array([-41.03250252873486, -35.70280591875908, -48.66938576680659, 94.51946988004894, 31.68700466174738,
...
class C11(ConstrainedFunction):
    ...
    def evaluate(self, X):
        x = np.array(X)
        z = M.dot(x - self.o[:self.D])
        return (1 / D) * np.sum([-1.0 * _z * cos(2 * sqrt(abs(_z))) for _z in z])
...
class C12(ConstrainedFunction):
    def __init__(self, dimensions):
        self.o = np.array([18.889635068428205, -59.265426383246485, 33.25998466165768, 20.152694275194037, -10.734106238462502,
